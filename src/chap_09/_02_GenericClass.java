...
//        c4Name = (String) c3.name; // 코드 실수를 한 경우 -> 에러

        System.out.println("---------------");

        Coffee<Integer> c5 = new Coffee<>(35);
        c5.ready();
        int c5Name = c5.name; // 형변환이 필요없다!!
        System.out.println("주문 고객 번호: " + c5Name);

        Coffee<String> c6 = new Coffee<>("조세호");
        c6.ready();
        String c6Name = c6.name; // 형변환이 필요없다!!
...
//        CoffeeByUser<User> c9 = new CoffeeByUser<>(new Blackbox()); // 불가능하다!!
